...
export const THEMES: Theme[] = [
  ...
  },
  {
    ...
    vars: {
      ...
      '--bg-tabs':        '#efe9ff',
      '--bg-editor':      '#f8f6ff',
      '--bg-hover':       'rgba(189,52,254,0.06)',
      '--bg-active':      'rgba(189,52,254,0.12)',
      '--bg-card':        'rgba(189,52,254,0.04)',
      '--border':         'rgba(0,0,0,0.09)',
      '--border-mid':     'rgba(189,52,254,0.28)',
      '--fg':             '#1a0a2e',
      '--fg-muted':       '#5a4a7a',
      '--fg-dim':         '#7a6a9a',
      '--grad-a':         '#bd34fe',
      '--grad-b':         '#ff9966',
      '--gradient':       'linear-gradient(135deg,#bd34fe 0%,#e8430a 55%,#ff9966 100%)',
      '--gradient-soft':  'linear-gradient(135deg,rgba(189,52,254,0.12) 0%,rgba(255,153,102,0.06) 100%)',
      '--gradient-text':  'linear-gradient(135deg,#bd34fe 0%,#e8430a 50%,#ff9966 100%)',
      '--gradient-line':  'linear-gradient(90deg,#bd34fe,#ff9966)',
      '--glow':           '0 0 20px rgba(189,52,254,0.18),0 0 60px rgba(189,52,254,0.06)',
      '--glow-card':      '0 4px 16px rgba(0,0,0,0.08),0 0 0 0.5px rgba(189,52,254,0.15)',
      '--dot-color':      'rgba(189,52,254,0.06)',
      '--glow-bg':        'rgba(189,52,254,0.04)',
    }
  },
  {
    id: 'dracula',
